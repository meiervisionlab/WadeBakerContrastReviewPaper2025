...
png('Figures/1_centresurround.png',width=12,height=6.5, units = 'in', res = 300)
...
png('Figures/2_linearsystem.png',width=12,height=4, units = 'in', res = 300)
par(mfrow=c(1,3))
...
png('Figures/3_fullwaverectification.png',width=12,height=4, units = 'in', res = 300)
par(mfrow=c(1,3))
...
png('Figures/4_transducer.png',width=12,height=4, units = 'in', res = 300)
par(mfrow=c(1,3))
...
png('Figures/5_twoinputs.png',width=12,height=4, units = 'in', res = 300)
par(mfrow=c(1,3))
...
png('Figures/6_sweepplot.png',width=6,height=6, units = 'in', res = 300)
...
png('Figures/7_clinicalplot.png',width=12,height=12, units = 'in', res = 300)
par(mfrow=c(2,2))
